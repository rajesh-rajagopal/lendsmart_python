.PHONY: clean install analysis test test-install develop
...
analysis:
	...
	. venv/bin/activate; flake8 --ignore=E402,F401,W391,W291,W293 lendsmart --max-line-length=300
...
cover:
	. venv/bin/activate; \
  find tests -type d | xargs nosetests --with-coverage --cover-inclusive --cover-erase --cover-package=lendsmart
