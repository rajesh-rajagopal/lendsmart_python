...
class Version(object):
    ...
    def exception(cls, method, uri, response, message):
        """
        Wraps an exceptional response in a `LendsmartRestException`.
        """
        ...
        try:
            ...
            return LendsmartRestException(response.status_code, uri, message, code, method)
        except Exception:
            return LendsmartRestException(response.status_code, uri, message, response.status_code, method)
