class Domain(object):
    """
    This represents at Lendsmart API subdomain.

    Like, `api.lendsmart.ai` or `beta.lendsmart.ai'.
    """
    def __init__(self, lendsmart):
        """
        :param Lendsmart lendsmart:
        :return:
        """
        self.lendsmart = lendsmart
        self.base_url = None
