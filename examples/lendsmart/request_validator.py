...
from lendsmart.compat import izip, urlparse, parse_qs
...
def remove_port(uri):
    ...
    :param uri: full URI that Lendsmart requested on your server
...
class RequestValidator(object):
    ...
    def compute_signature(self, uri, params, utf=PY3):
        ...
        :param uri: full URI that Lendsmart requested on your server
        :param params: post vars that Lendsmart sent with the request
    ...
    def validate(self, uri, params, signature):
        """Validate a request from Lendsmart

        :param uri: full URI that Lendsmart requested on your server
        :param params: dictionary of POST variables or string of POST body for JSON requests
        :param signature: expected signature in HTTP X-Lendsmart-Signature header
