...
from lendsmart.http.request import Request as LendsmartRequest
import logging
from lendsmart.compat import urlencode

_logger = logging.getLogger('lendsmart.http_client')


class LendsmartHttpClient(HttpClient):
    """
    General purpose HTTP Client for interacting with the Lendsmart API
    """
    ...
    def request(self, method, url, params=None, data=None, headers=None, auth=None, timeout=None,
        ...
        self.last_request = LendsmartRequest(**kwargs)
