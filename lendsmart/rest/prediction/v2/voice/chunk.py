...
class CountryList(ListResource):
    ...
    def __init__(self, version):
        ...
        :returns: lendsmart.rest.pricing.v2.voice.country.CountryList
        :rtype: lendsmart.rest.pricing.v2.voice.country.CountryList
        """
    ...
    def stream(self, limit=None, page_size=None):
        ...
        :rtype: list[lendsmart.rest.pricing.v2.voice.country.CountryInstance]
        """
    ...
    def page(self, page_token=values.unset, page_number=values.unset,
        ...
        :rtype: lendsmart.rest.pricing.v2.voice.country.CountryPage
        """
    ...
    def get_page(self, target_url):
        ...
        :rtype: lendsmart.rest.pricing.v2.voice.country.CountryPage
        """
        response = self._version.domain.lendsmart.request(
            'GET',
            target_url,
        )
    ...
    def get(self, iso_country):
        ...
        :returns: lendsmart.rest.pricing.v2.voice.country.CountryContext
        :rtype: lendsmart.rest.pricing.v2.voice.country.CountryContext
        """
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Lendsmart.Pricing.V2.CountryList>'
...
class CountryPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: lendsmart.rest.pricing.v2.voice.country.CountryPage
        :rtype: lendsmart.rest.pricing.v2.voice.country.CountryPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: lendsmart.rest.pricing.v2.voice.country.CountryInstance
        :rtype: lendsmart.rest.pricing.v2.voice.country.CountryInstance
        """
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Lendsmart.Pricing.V2.CountryPage>'
...
class CountryContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return '<Lendsmart.Pricing.V2.CountryContext {}>'.format(context)
...
class CountryInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Lendsmart.Pricing.V2.CountryInstance {}>'.format(context)
