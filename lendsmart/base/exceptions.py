...
class LendsmartException(Exception):
    pass


class LendsmartRestException(LendsmartException):
    """ A generic 400 or 500 level exception from the Lendsmart API
    ...
    :param int|None code: A Lendsmart-specific error code for the error. This is
    ...
    def __str__(self):
        ...
        def get_uri(code):
            return "https://www.lendsmart.com/docs/errors/{0}".format(code)
        ...
        if hasattr(sys.stderr, 'isatty') and sys.stderr.isatty():
            msg = (
                ...
                "\n\n{lendsmart_returned}\n\n{message}\n".format(
                    ...
                    lendsmart_returned=white(
                        "Lendsmart returned the following information:"),
