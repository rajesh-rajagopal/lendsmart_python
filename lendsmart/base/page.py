...
class Page(object):
    ...
    def process_response(self, response):
        ...
        if response.status_code != 200:
            raise LendsmartException('Unable to fetch page', response)
    ...
    def load_page(self, payload):
        ...
        raise LendsmartException('Page Records can not be deserialized')
    ...
    def get_instance(self, payload):
        ...
        """
        raise LendsmartException('Page.get_instance() must be implemented in the derived class')
    ...
    def next_page(self):
        ...
        response = self._version.domain.lendsmart.request('GET', self.next_page_url)
        cls = type(self)
    ...
    def previous_page(self):
        ...
        response = self._version.domain.lendsmart.request('GET', self.previous_page_url)
        cls = type(self)
        return cls(self._version, response, self._solution)
